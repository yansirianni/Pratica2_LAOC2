...
add wave -noupdate /system/proc1/ID_EX/read_data1
add wave -noupdate /system/proc1/ID_EX/read_data2
add wave -noupdate /system/proc1/ID_EX/dataRFOut1
add wave -noupdate /system/proc1/ID_EX/dataRFOut2
...
add wave -noupdate /system/proc1/EX_MEM/aluRESULT
add wave -noupdate /system/proc1/EX_MEM/aluZEROout
add wave -noupdate /system/proc1/EX_MEM/aluRESULTout
...
add wave -noupdate /system/proc1/MEM_WB/aluRESULT
add wave -noupdate /system/proc1/MEM_WB/memory_read_data
add wave -noupdate /system/proc1/MEM_WB/aluRESULTout
...
add wave -noupdate /system/proc1/WB/aluRESULTout
add wave -noupdate /system/proc1/WB/memoryReadData
add wave -noupdate /system/proc1/WB/address
add wave -noupdate /system/proc1/WB/writeBackEnable
add wave -noupdate /system/proc1/WB/writeBackAddress_Out
add wave -noupdate /system/proc1/WB/writeBackData_Out
