...
add wave -noupdate /system/proc1/MEM/address
add wave -noupdate /system/proc1/MEM/writeData
add wave -noupdate /system/proc1/MEM/writeEnable
add wave -noupdate /system/proc1/MEM/writeEnable_Out
add wave -noupdate /system/proc1/MEM/writeData_Out
add wave -noupdate /system/proc1/MEM/address_Out
add wave -noupdate /system/proc1/MEM/instructionPropagation
...
WaveRestoreCursors {{Cursor 1} {358 ps} 0}
...
update
WaveRestoreZoom {865 ps} {1323 ps}
view wave 
