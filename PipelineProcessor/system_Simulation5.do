...
add wave -noupdate /system/proc1/MEM/instruction
add wave -noupdate /system/proc1/MEM/writeEnable_Out
add wave -noupdate -radix unsigned /system/proc1/MEM/writeData_Out
add wave -noupdate -radix unsigned /system/proc1/MEM/address_Out
...
add wave -noupdate -radix unsigned -childformat {{{/system/proc1/MEM_WB/memory_read_data_out[19]} -radix unsigned} {{/system/proc1/MEM_WB/memory_read_data_out[18]} -radix unsigned} {{/system/proc1/MEM_WB/memory_read_data_out[17]} -radix unsigned} {{/system/proc1/MEM_WB/memory_read_data_out[16]} -radix unsigned} {{/system/proc1/MEM_WB/memory_read_data_out[15]} -radix unsigned} {{/system/proc1/MEM_WB/memory_read_data_out[14]} -radix unsigned} {{/system/proc1/MEM_WB/memory_read_data_out[13]} -radix unsigned} {{/system/proc1/MEM_WB/memory_read_data_out[12]} -radix unsigned} {{/system/proc1/MEM_WB/memory_read_data_out[11]} -radix unsigned} {{/system/proc1/MEM_WB/memory_read_data_out[10]} -radix unsigned} {{/system/proc1/MEM_WB/memory_read_data_out[9]} -radix unsigned} {{/system/proc1/MEM_WB/memory_read_data_out[8]} -radix unsigned} {{/system/proc1/MEM_WB/memory_read_data_out[7]} -radix unsigned} {{/system/proc1/MEM_WB/memory_read_data_out[6]} -radix unsigned} {{/system/proc1/MEM_WB/memory_read_data_out[5]} -radix unsigned} {{/system/proc1/MEM_WB/memory_read_data_out[4]} -radix unsigned} {{/system/proc1/MEM_WB/memory_read_data_out[3]} -radix unsigned} {{/system/proc1/MEM_WB/memory_read_data_out[2]} -radix unsigned} {{/system/proc1/MEM_WB/memory_read_data_out[1]} -radix unsigned} {{/system/proc1/MEM_WB/memory_read_data_out[0]} -radix unsigned}} -subitemconfig {{/system/proc1/MEM_WB/memory_read_data_out[19]} {-height 15 -radix unsigned} {/system/proc1/MEM_WB/memory_read_data_out[18]} {-height 15 -radix unsigned} {/system/proc1/MEM_WB/memory_read_data_out[17]} {-height 15 -radix unsigned} {/system/proc1/MEM_WB/memory_read_data_out[16]} {-height 15 -radix unsigned} {/system/proc1/MEM_WB/memory_read_data_out[15]} {-height 15 -radix unsigned} {/system/proc1/MEM_WB/memory_read_data_out[14]} {-height 15 -radix unsigned} {/system/proc1/MEM_WB/memory_read_data_out[13]} {-height 15 -radix unsigned} {/system/proc1/MEM_WB/memory_read_data_out[12]} {-height 15 -radix unsigned} {/system/proc1/MEM_WB/memory_read_data_out[11]} {-height 15 -radix unsigned} {/system/proc1/MEM_WB/memory_read_data_out[10]} {-height 15 -radix unsigned} {/system/proc1/MEM_WB/memory_read_data_out[9]} {-height 15 -radix unsigned} {/system/proc1/MEM_WB/memory_read_data_out[8]} {-height 15 -radix unsigned} {/system/proc1/MEM_WB/memory_read_data_out[7]} {-height 15 -radix unsigned} {/system/proc1/MEM_WB/memory_read_data_out[6]} {-height 15 -radix unsigned} {/system/proc1/MEM_WB/memory_read_data_out[5]} {-height 15 -radix unsigned} {/system/proc1/MEM_WB/memory_read_data_out[4]} {-height 15 -radix unsigned} {/system/proc1/MEM_WB/memory_read_data_out[3]} {-height 15 -radix unsigned} {/system/proc1/MEM_WB/memory_read_data_out[2]} {-height 15 -radix unsigned} {/system/proc1/MEM_WB/memory_read_data_out[1]} {-height 15 -radix unsigned} {/system/proc1/MEM_WB/memory_read_data_out[0]} {-height 15 -radix unsigned}} /system/proc1/MEM_WB/memory_read_data_out
add wave -noupdate -childformat {{{/system/mem1/Mem[27]} -radix unsigned}} -subitemconfig {{/system/mem1/Mem[27]} {-height 15 -radix unsigned}} /system/mem1/Mem
add wave -noupdate /system/Clock
add wave -noupdate /system/Reset
...
update
WaveRestoreZoom {809 ps} {2312 ps}
view wave 
